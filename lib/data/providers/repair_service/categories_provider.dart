...
final mainCategoriesProvider = FutureProvider.autoDispose<List<Category>>((ref) async {
  CatalogRepository repository = ref.read(catalogRepositoryProvider);
  return repository.mainCategories();
});

final subCategoriesProvider = FutureProvider.autoDispose.family<List<Category>, String>((ref, parentId) async {
  CatalogRepository repository = ref.read(catalogRepositoryProvider);
